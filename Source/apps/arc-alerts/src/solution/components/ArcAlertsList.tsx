...
const alerts = [
  { title: 'Weather advisory', type: 'Weather', audience: 'All families', channels: 'Text · Email · Push', sent: 'Today, 10:42 AM', delivered: '2,314 / 2,340', status: 'Delivered' },
  { title: 'Route 4 delay', type: 'Transportation', audience: 'Transport group', channels: 'Text · Push', sent: 'Today, 8:14 AM', delivered: '186 / 188', status: 'Delivered' },
  ...
  { title: 'Parish event update', type: 'Event', audience: 'Parish families', channels: 'Email · Push', sent: 'Yesterday, 2:15 PM', delivered: '482 / 486', status: 'Pending' },
