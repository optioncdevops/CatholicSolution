...
namespace CFR.AcutisInfrastructure.Models.Output
{
    ...
    /// Holds one license issued against any organization's assigned product, via
    /// lic.License + lic.OrganizationProduct + core.Product + core.Organization — the
    /// platform-wide counterpart to OrganizationLicenseOutput (ActionId 10, single-org).
    /// </summary>
    public class LicenseSummaryOutput
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the organization identifier the license belongs to.
        /// </summary>
