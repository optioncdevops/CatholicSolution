...
namespace CFR.AcutisInfrastructure
{
    ...
    public static class DBParameterName
    {
        ...
        public static class ProductRequestParams
        {
            ...
            /// <summary>
            /// ActionId 4 only: generated by the caller and saved into [sec].[ApiClient].[ClientSecret].
            /// </summary>
            public const string ClientSecret = nameof(ClientSecret);

            /// <summary>
            /// ActionId 4 only (output): the [sec].[ApiClient].[ClientId] created for the new product.
            /// </summary>
