...
-- CFR.DataSync Phase 1 — stored procedures for HMAC client lookups / replay / idempotency
...
-- Single-user create/update/get/deactivate/reactivate for the CFR.DataSync API. Every
