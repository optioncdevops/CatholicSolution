...
import type { CustomDataTableTooltipState } from "../../customDataTable/components/CustomDataTableTooltipPortal";

interface CustomServerSideDataTableTooltipPortalProps {
  tooltip: CustomDataTableTooltipState;
}

export function CustomServerSideDataTableTooltipPortal({
  tooltip,
}: CustomServerSideDataTableTooltipPortalProps) {
