...
export const COLUMN_VISIBILITY_POPOVER_SHELL_CLASS =
  "z-35 mt-0 flex w-max min-w-[11rem] max-w-[min(22rem,calc(100vw-1.5rem))] flex-col overflow-hidden rounded-md border border-slate-200 bg-white py-2 text-xs shadow-lg dark:border-slate-700 dark:bg-slate-900";
...
export const COLUMN_VISIBILITY_LABEL_CLASS =
  "whitespace-nowrap text-slate-700 dark:text-slate-100";
