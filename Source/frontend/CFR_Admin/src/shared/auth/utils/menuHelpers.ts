 ...
 * and the dev-only component-library sample pages have no feature row whatsoever). */
const UNGATED_ROUTE_PREFIXES = ['/admin/profile', '/admin/administration/component-library'];
