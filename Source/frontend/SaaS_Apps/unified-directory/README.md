# Unified Directory — standalone external SaaS source
...
- **Application ID:** `unified-directory`
- **Expected production domain:** `https://directory.optioncapp.com`
...
```html
<catholic-solutions-app-switcher current-app-id="unified-directory"></catholic-solutions-app-switcher>
```
