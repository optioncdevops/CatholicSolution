# Support Center — standalone external SaaS source
...
- **Application ID:** `support-center`
- **Expected production domain:** `https://support-center.optioncapp.com`
...
```html
<catholic-solutions-app-switcher current-app-id="support-center"></catholic-solutions-app-switcher>
```
