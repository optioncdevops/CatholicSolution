# Matt Money — standalone external SaaS source
...
- **Application ID:** `matt-money`
- **Expected production domain:** `https://matt-money.optioncapp.com`
...
```html
<catholic-solutions-app-switcher current-app-id="matt-money"></catholic-solutions-app-switcher>
```
