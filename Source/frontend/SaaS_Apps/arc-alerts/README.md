# ArcAlerts — standalone external SaaS source
...
- **Application ID:** `arc-alerts`
- **Expected production domain:** `https://arc-alerts.optioncapp.com`
...
```html
<catholic-solutions-app-switcher current-app-id="arc-alerts"></catholic-solutions-app-switcher>
```
