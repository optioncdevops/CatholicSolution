# OptionC School — standalone external SaaS source
...
- **Application ID:** `optionc-school`
- **Expected production domain:** `https://optionc-sms.optioncapp.com`
...
```html
<catholic-solutions-app-switcher current-app-id="optionc-school"></catholic-solutions-app-switcher>
```
