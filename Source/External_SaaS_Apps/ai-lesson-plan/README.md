# AI Lesson Plan Generator — standalone external SaaS source
...
- **Application ID:** `ai-lesson-plan`
- **Expected production domain:** `https://demo.optionc.com/XtraCoach`
...
```html
<catholic-solutions-app-switcher current-app-id="ai-lesson-plan"></catholic-solutions-app-switcher>
```
